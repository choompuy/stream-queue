...
export const INFO_ICON = (size) => `
  <svg xmlns="http://www.w3.org/2000/svg" width="${size || 20}" height="${size || 20}" fill="none" viewBox="0 0 24 24">
    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 16v-4m0-4h.01M22 12a10 10 0 1 1-20 0 10 10 0 0 1 20 0Z" />
  </svg>
`

export const CLOSE_ICON = (size) => `
  <svg xmlns="http://www.w3.org/2000/svg" width="${size || 20}" height="${size || 20}" fill="none" viewBox="0 0 24 24">
