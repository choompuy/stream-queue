...
const { router } = await import('../../../src/http/routes/queue.js')
const { router: searchRouter } = await import('../../../src/http/routes/search.js')
const { updateConfig } = await import('../../../src/config/index.js')
const { updateSecrets } = await import('../../../src/infrastructure/persistence/secrets.js')
