...
import type { VideoItem } from '../../../src/integrations/youtube/types.js'
import { AppError, type Song } from '../../../src/shared/types.js'
...
const { isAvailableInRegion, getFilterFailureReason, throwFilterError } = await import('../../../src/integrations/youtube/api-client.js')
const { updateConfig } = await import('../../../src/config/index.js')
